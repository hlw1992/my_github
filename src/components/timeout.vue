  ...
  <div id='timeout'>
    ...
    <div class='controls'>
      <div>
        ...
        <el-input-number size="mini" v-model="doNum" @change="handleChange" :step="1" :min="1" :max="50" step-strictly :disabled="numDis"></el-input-number>
      </div>
      <div>
        <p>休息时间<span>(分钟)</span></p>
        <el-input-number size="mini" v-model="restNum" @change="handleChangeR" :step="1" :min="1" :max="10" step-strictly :disabled="numDis"></el-input-number>
      </div>
    </div>
    <!-- 显示圆圈和信息 -->
...
<style scoped>
  ...
  .controls div:first-child,.controls div:last-child{
    width: 30%;
  }
  .controls div p{
    margin: 0.5rem 0;
